...
public class cadastro_cliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Text_titulo.setText("Cadastro de Cliente");
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(Campo_telefone, javax.swing.GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(Text_rg)
                        .addGap(18, 18, 18)
                        .addComponent(Campo_rg, javax.swing.GroupLayout.PREFERRED_SIZE, 232, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(47, 47, 47))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(302, 302, 302)
    ...
    private void BotaoDecadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoDecadastroActionPerformed
        ...
        if(Senha.equals(Campo_ConfirmarSenha.getText())){   
            try{
                String insert_sql="INSERT INTO cliente (senha_Cliente, CPF_Cliente, RG_Cliente, nome_Cliente, UF_Cliente, endereco_Cliente, telefone_Cliente, email_Cliente, nasc_Cliente) VALUES ('" + Senha + "','" + CPF + "','" + RG + "','" + Nome + "','" + UF + "','" + Endereco + "','" + Tel + "','" + Email + "','" + data_nasc + "')";
