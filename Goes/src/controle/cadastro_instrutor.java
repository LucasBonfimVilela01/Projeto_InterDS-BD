...
public class cadastro_instrutor extends javax.swing.JFrame {
    
    Conexao con_instrutor;

    public cadastro_instrutor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Text_titulo.setText("Cadastro de Instrutor");
    ...
    private void BotaoDecadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoDecadastroActionPerformed
        ...
        if(Senha.equals(Campo_ConfirmarSenha.getText())){   
            try{
                String insert_sql="INSERT INTO instrutor (senha_Instrutor, CPF_Instrutor, RG_Instrutor, nome_Instrutor, UF_Instrutor, endereco_Instrutor, telefone_Instrutor, email_Instrutor, nasc_Instrutor, formacao_Instrutor) VALUES ('" + Senha + "','" + CPF + "','" + RG + "','" + Nome + "','" + UF + "','" + Endereco + "','" + Tel + "','" + Email + "','" + data_nasc + "','" + Formacao + "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cadastro_instrutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
